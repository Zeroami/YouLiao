...
public class LCircleImageView extends ImageView {
    ...
    public LCircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取边界的宽度
        mBorderWidth = a.getDimensionPixelSize(R.styleable.LCircleImageView_border_width, DEFAULT_BORDER_WIDTH);
        // 获取边界的颜色
        mBorderColor = a.getColor(R.styleable.LCircleImageView_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.LCircleImageView_border_overlay, DEFAULT_BORDER_OVERLAY);
