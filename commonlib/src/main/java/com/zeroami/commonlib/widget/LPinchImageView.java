...
/**
 * <p>作者：Zeroami，原作者：clifford</p>
 * <p>邮箱：826589183@qq.com</p>
 * <p>描述：手势缩放平移图片控件</p>
 */
public class LPinchImageView extends ImageView {
    ...
    public LPinchImageView(Context context) {
        super(context);
        initView();
    }

    public LPinchImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public LPinchImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    //点击，双击，长按，滑动等手势处理
    private GestureDetector mGestureDetector = new GestureDetector(LPinchImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(LPinchImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mOnClickListener != null) {
                mOnClickListener.onClick(LPinchImageView.this);
            }
            return true;
        }
    });
