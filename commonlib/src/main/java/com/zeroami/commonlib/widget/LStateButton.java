...
/**
 * <p>作者：Zeroami，原作者：deadline</p>
 * <p>邮箱：826589183@qq.com</p>
 * <p>描述：状态按钮控件</p>
 */
public class LStateButton extends AppCompatButton {
    ...
    public LStateButton(Context context) {
        this(context, null);
    }

    public LStateButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public LStateButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LStateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.LStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.LStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.LStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.LStateButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.LStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.LStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.LStateButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.LStateButton_radius, 0);
        mRound = a.getBoolean(R.styleable.LStateButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.LStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.LStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.LStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.LStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.LStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.LStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.LStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.LStateButton_unableStrokeColor, 0);
        setStroke();
