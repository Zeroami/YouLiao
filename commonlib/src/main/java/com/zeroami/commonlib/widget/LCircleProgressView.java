 ...
 * <p>描述：圆形进度条控件</p>
 */
public class LCircleProgressView extends View
{
     ...
     * @param attrs
     */
    public LCircleProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.LCircleProgressView));
    }
     ...
     * @param context
     */
    public LCircleProgressView(Context context) {
        super(context);
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.LCircleProgressView_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.LCircleProgressView_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.LCircleProgressView_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.LCircleProgressView_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.LCircleProgressView_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.LCircleProgressView_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.LCircleProgressView_barColor, barColor);

        rimColor = a.getColor(R.styleable.LCircleProgressView_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.LCircleProgressView_linearProgress, false);

        if (a.getBoolean(R.styleable.LCircleProgressView_progressIndeterminate, false)) {
            spin();
        }
