 ...
 * <p>描述：RecyclerView添加一个或多个HeadAndFoot辅助类</p>
 */
public class LHeaderRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LHeaderRecyclerViewAdapter(RecyclerView.Adapter adapter) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (viewType < HEADERS_START + getHeaderCount())
            return new LStaticViewHolder(mHeaderViews.get(viewType - HEADERS_START));
        else if (viewType < FOOTERS_START + getFooterCount())
            return new LStaticViewHolder(mFooterViews.get(viewType - FOOTERS_START));
        else {
    ...
    private static class LStaticViewHolder extends RecyclerView.ViewHolder {

        public LStaticViewHolder(View itemView) {
